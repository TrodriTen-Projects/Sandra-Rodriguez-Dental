...
import { BRAND, EXTERNAL_LINKS } from '@/content';
    ...
    <footer className="w-full bg-primaryDark pt-20 pb-3 border-t border-primary text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center text-sm text-gray-300 mt-8">
          ...
          Sitio creado por <a href={EXTERNAL_LINKS.DEVELOPER_PORTFOLIO} target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-400">TrodriTen</a>.
        </div>
      </div>
    </footer>
  );
